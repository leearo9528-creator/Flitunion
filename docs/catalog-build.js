...
const SL = [
 ...
 { slug:"henna", t:"헤나 · 페이스페인팅", n:"2곳", d:"헤나 타투와 페이스페인팅. 아이 동반 행사 필수 부스" },
 { slug:"wood", t:"목공예", n:"2곳", d:"원목 소품, 바느질 도구, 데스크 오거나이저" },
 { slug:"badge", t:"뱃지", n:"2곳", d:"캘리그래피·그림 뱃지 제작" },
 { slug:"tattoo", t:"타투 스티커", n:"2곳", d:"주문제작 타투 스티커, 타투 아트 전시·체험" },
 { slug:"leather", t:"가죽공예", n:"1곳", d:"카드지갑, 키링 등 DIY 패키지 형태의 가죽 체험" },
 { slug:"rattan", t:"라탄 공예", n:"1곳", d:"라탄 바구니, 트레이, 소품" },
 { slug:"felt", t:"양모펠트", n:"1곳", d:"양모를 찔러 굳혀 만드는 인형, 브로치" },
...
(async () => {
  ...
  await build("플리마켓 셀러 품목", "보유 셀러가 많은 순 30종", SL, SL_DIR,
