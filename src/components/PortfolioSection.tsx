      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {portfolioItems.map((item) => {
            ...
            return (
              <div key={item.id} className={`${isOpen ? "sm:col-span-2 lg:col-span-3" : "lg:col-span-1"} transition-all`}>
                <article
                  ...
                  {isOpen && (
                    ...
                    >
                      ...
                      <div className="mt-6 text-center">
                        <a
                          href="#contact"
                          className="inline-flex items-center gap-2 px-6 py-2.5 text-white text-sm font-bold rounded-xl transition-colors"
        ...
        {/* CTA Banner */}
        <div className="mt-10 rounded-2xl p-10 text-center text-white" style={{ background: "#3182f6" }}>
          ...
          <a
            href="#contact"
            className="inline-flex items-center gap-2 px-8 py-3 bg-white font-bold rounded-xl transition-colors text-sm"
            style={{ color: "#3182f6" }}
