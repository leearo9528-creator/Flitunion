export default function Footer() {
  ...
  return (
    <footer className="bg-gray-950 text-gray-400 py-14" role="contentinfo">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 mt-5 text-sm font-medium text-brand hover:text-brand-dark transition-colors"
              aria-label="플릿 플랫폼 바로가기"
            >
              <span className="w-5 h-5 rounded flex items-center justify-center text-white text-xs font-black bg-brand" aria-hidden="true">F</span>
              플릿(Flit) 플랫폼 바로가기 →
            </a>
          </div>
          ...
          <address className="not-italic">
            ...
            <ul className="space-y-2.5 text-sm">
              <li>
                <a href="tel:+821080188492" className="hover:text-white transition-colors">010-8018-8492</a>
              </li>
              <li>
                <a href="mailto:hello@flitunion.co.kr" className="hover:text-white transition-colors">hello@flitunion.co.kr</a>
              </li>
        ...
        <div className="border-t border-gray-800 pt-6 flex flex-col sm:flex-row justify-between items-center gap-4 text-xs text-gray-600">
          ...
          <nav aria-label="하단 링크">
            <ul className="flex gap-5">
              <li><a href="#" className="hover:text-gray-400 transition-colors">개인정보처리방침</a></li>
              <li><a href="#" className="hover:text-gray-400 transition-colors">이용약관</a></li>
            </ul>
          </nav>
        </div>
